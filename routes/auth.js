...
router.post('/register', async (req, res) => {
  try {
    const {email, password, repeat, name} = req.body // получаем поля формы
    const candidate = await User.findOne({ email }) // проверяем по email зарегистрирован ли такой пользователь
